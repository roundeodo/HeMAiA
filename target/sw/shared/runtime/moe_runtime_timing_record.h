...
enum bingo_moe_runtime_timing_stage {
    ...
    MOE_PROFILE_STAGE_M8_FIXED_A_BEGIN,
    MOE_PROFILE_STAGE_M8_FIXED_A_END,
    MOE_PROFILE_STAGE_M8_FIXED_B_BEGIN,
    MOE_PROFILE_STAGE_M8_FIXED_B_END,
    MOE_PROFILE_STAGE_M8_FIXED_C_BEGIN,
    MOE_PROFILE_STAGE_M8_FIXED_C_END,
    MOE_PROFILE_STAGE_M8_DISTILLED_BEGIN,
    MOE_PROFILE_STAGE_M8_DISTILLED_END,
    MOE_PROFILE_STAGE_M32_FIXED_A_BEGIN,
    MOE_PROFILE_STAGE_M32_FIXED_A_END,
    MOE_PROFILE_STAGE_M32_FIXED_B_BEGIN,
    MOE_PROFILE_STAGE_M32_FIXED_B_END,
    MOE_PROFILE_STAGE_M32_FIXED_C_BEGIN,
    MOE_PROFILE_STAGE_M32_FIXED_C_END,
    MOE_PROFILE_STAGE_M32_DISTILLED_BEGIN,
    MOE_PROFILE_STAGE_M32_DISTILLED_END,
};
