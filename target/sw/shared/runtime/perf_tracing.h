...
#define BINGO_TRACE_HOST_MOE_EXEC_INIT_SETUP_START       0x3A0
#define BINGO_TRACE_HOST_MOE_EXEC_INIT_SETUP_END         0x3A1
#define BINGO_TRACE_HOST_MOE_EXEC_INIT_COUNT_START       0x3A2
#define BINGO_TRACE_HOST_MOE_EXEC_INIT_COUNT_END         0x3A3
#define BINGO_TRACE_HOST_MOE_EXEC_INIT_HEADER_START      0x3A4
#define BINGO_TRACE_HOST_MOE_EXEC_INIT_HEADER_END        0x3A5
#define BINGO_TRACE_HOST_MOE_EXEC_INIT_SLOT_C2_START     0x3A6
#define BINGO_TRACE_HOST_MOE_EXEC_INIT_SLOT_C2_END       0x3A7
#define BINGO_TRACE_HOST_MOE_EXEC_INIT_SLOT_C3_START     0x3A8
#define BINGO_TRACE_HOST_MOE_EXEC_INIT_SLOT_C3_END       0x3A9

// Host HW scheduler MMIO driver sub-stage markers (0x3AA - 0x3B7)
// These split BINGO_TRACE_HOST_MOE_HW_SCHED for diagnosis; they do not change logic.
#define BINGO_TRACE_HOST_MOE_HW_SORT_START               0x3AA
#define BINGO_TRACE_HOST_MOE_HW_SORT_END                 0x3AB
#define BINGO_TRACE_HOST_MOE_HW_INIT_WRITE_START         0x3AC
#define BINGO_TRACE_HOST_MOE_HW_INIT_WRITE_END           0x3AD
#define BINGO_TRACE_HOST_MOE_HW_WAIT_START               0x3AE
#define BINGO_TRACE_HOST_MOE_HW_WAIT_END                 0x3AF
#define BINGO_TRACE_HOST_MOE_HW_STATUS_DECODE_START      0x3B0
#define BINGO_TRACE_HOST_MOE_HW_STATUS_DECODE_END        0x3B1
#define BINGO_TRACE_HOST_MOE_HW_CONTROL_WRITE_START      0x3B2
...
#define BINGO_TRACE_HOST_MOE_HW_LOWER_COUNT_START         0x3B8
#define BINGO_TRACE_HOST_MOE_HW_LOWER_COUNT_END           0x3B9
#define BINGO_TRACE_HOST_MOE_HW_LOWER_TASK_BUILD_START    0x3BA
#define BINGO_TRACE_HOST_MOE_HW_LOWER_TASK_BUILD_END      0x3BB
#define BINGO_TRACE_HOST_MOE_HW_LOWER_PENDING_PATCH_START 0x3BC
#define BINGO_TRACE_HOST_MOE_HW_LOWER_PENDING_PATCH_END   0x3BD
#define BINGO_TRACE_HOST_MOE_HW_LOWER_SLOT_SELECT_START   0x3BE
#define BINGO_TRACE_HOST_MOE_HW_LOWER_SLOT_SELECT_END     0x3BF
#define BINGO_TRACE_HOST_MOE_HW_LOWER_ARG_PROGRAM_START   0x3C0
#define BINGO_TRACE_HOST_MOE_HW_LOWER_ARG_PROGRAM_END     0x3C1
#define BINGO_TRACE_HOST_MOE_HW_LOWER_DMA_PATCH_START     0x3C2
#define BINGO_TRACE_HOST_MOE_HW_LOWER_DMA_PATCH_END       0x3C3
#define BINGO_TRACE_HOST_MOE_HW_LOWER_FINAL_STATE_START   0x3C4
#define BINGO_TRACE_HOST_MOE_HW_LOWER_FINAL_STATE_END     0x3C5

// Dynamic MoE S4 phase-pipeline diagnostics.
#define BINGO_TRACE_DEV_MOE_S4PF_PHASE0_START              0x3C6
#define BINGO_TRACE_DEV_MOE_S4PF_PHASE0_END                0x3C7
#define BINGO_TRACE_DEV_MOE_S4PF_PHASE1_START              0x3C8
#define BINGO_TRACE_DEV_MOE_S4PF_PHASE1_END                0x3C9
#define BINGO_TRACE_DEV_MOE_S4COMP_PHASE0_START            0x3CA
#define BINGO_TRACE_DEV_MOE_S4COMP_PHASE0_END              0x3CB
#define BINGO_TRACE_DEV_MOE_S4COMP_PHASE1_START            0x3CC
#define BINGO_TRACE_DEV_MOE_S4COMP_PHASE1_END              0x3CD
