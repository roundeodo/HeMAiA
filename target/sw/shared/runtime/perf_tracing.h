...
#define BINGO_TRACE_HOST_MOE_EXEC_INIT_STATE_START       0x3A4
#define BINGO_TRACE_HOST_MOE_EXEC_INIT_STATE_END         0x3A5
...
#define BINGO_TRACE_HOST_MOE_HW_READ_REMOVE_START        0x3B0
#define BINGO_TRACE_HOST_MOE_HW_READ_REMOVE_END          0x3B1
#define BINGO_TRACE_HOST_MOE_HW_HEAD_UPDATE_START        0x3B2
#define BINGO_TRACE_HOST_MOE_HW_HEAD_UPDATE_END          0x3B3
