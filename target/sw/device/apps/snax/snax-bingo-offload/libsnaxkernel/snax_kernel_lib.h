...
SNAX_SYMTAB_SECTION const snax_symbol_t __snax_symtab[] = {
    ...
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_stage_tokens_2d),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_stage_weight_pair_2d),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_store_tokens_2d),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_init_output_gaps),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dynamic_expert_gather_s1),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dynamic_expert_prepare_pipeline),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dynamic_expert_load_gate_up_block),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dynamic_expert_configure_gate_up_block0),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dynamic_expert_compute_gate_up_block),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dynamic_expert_compute_gate_up_block_pc),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_load_s1_stage),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_compute_s1_stage_pc),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dynamic_expert_load_down_block),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dynamic_expert_configure_down_block0),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dynamic_expert_compute_down_block),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dynamic_expert_compute_down_block_pc),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_load_s3_stage),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_compute_s3_stage_pc),
    ...
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_prefetch_s4_phase_batched),
    ...
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_compute_s4_phase_batched),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dynamic_expert_prepare_store_xdma_2d),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dynamic_expert_store_and_gather_next),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_opt_gather_s1),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_opt_load_s1_stage),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_opt_config_s1_block0),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_opt_compute_s1_stage),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_opt_prefetch_s2),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_opt_compute_s2),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_opt_load_s3_stage),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_opt_config_s3_block0),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_dyn_opt_compute_s3_stage),
    ...
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_active_cfg_s2_preload_s3_test),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_active_cfg_cache_hit_s2_preload_s4_test),
    SNAX_EXPORT_FUNC(__snax_bingo_kernel_moe_active_cfg_run_s3_test),
