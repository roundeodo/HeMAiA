...
#define expert_hidden_dimension  64    // N_hidden = N2×N1×meshCol = 2×8×4 = 64
#define router_output_dimension  8     // N_router = N1_r×meshCol = 2×4 = 8
#define output_dimension         64    // N_out (down proj) = N2_down×N1_down×down_meshCol = 2×4×8 = 64
...
// Token 配置
#define max_input_tokens         8     // 输入 token 数（= M1 × meshRow = 1 × 8 ）
